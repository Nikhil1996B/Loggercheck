...
import ActivateDevicecontainer from "./activatedevicecontainer";
import ActivateDevicePageLayout from "./activatedevicepagelayout";
...
const availableContentDetailsPageComponent = [
  ...
  {
    module_id: "activate-device-component",
    component: ActivateDevicecontainer,
  },
  {
...
function ActivateDevicePageContent({ user }) {
  // Initial setup
...
export default ActivateDevicePageContent;
