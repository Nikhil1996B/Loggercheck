...
function ForgotPassword() {
    ...
    const forgotPasswordEmailStatus = useSelector(state => pathOr('', ['userAuth', 'forgotpasswordreq', 'records', 'responseCode'])(state));
    const forgotPasswordEmailStatusMessage = useSelector(state => pathOr('', ['userAuth', 'forgotpasswordreq', 'records', 'message'])(state));
